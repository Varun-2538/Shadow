        ...
        <div className="bg-gradient-radial top-0 left-0 from-slate-900 to-stone-950">
          <div className="flex-grow min-h-screen flex items-center justify-center flex-col text-white px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex space-x-4">
              <button className="bg-slate-800 no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-xs sm:text-sm md:text-base font-semibold leading-6 text-white inline-block">
                <span className="absolute inset-0 overflow-hidden rounded-full">
                  <span className="absolute inset-0 rounded-full bg-[image:radial-gradient(75%_100%_at_50%_0%,rgba(56,189,248,0.6)_0%,rgba(56,189,248,0)_75%)] opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
                </span>
                <div onClick={handleClick} className="relative flex text-base sm:text-lg md:text-xl space-x-2 items-center z-10 rounded-full bg-zinc-950 py-0.5 px-4 ring-1 ring-white/10 ">
